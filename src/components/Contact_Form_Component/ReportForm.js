    ...
    <div className="reportPart">
      ...
      {isAno && isAno === true && isAno !== null && (
        ...
        >
          ...
          <label>באיזה עיר החרם התרחש?</label>
          <Select
            defaultValue={city}
            theme={(theme) => ({
              ...theme,
          ...
          <label>יודעים באיזה מסגרת?</label>
          <select
            className={classes.formControl}
            required
            value={place}
          ...
          <label>באיזה תאריך החרם קרה?</label>
          <input
            className={classes.formControl}
            type="date"
            required
          ...
          <label>תיאור קצר של המקרה:</label>
          <textarea
            className={classes.formControl}
            required
            value={message}
