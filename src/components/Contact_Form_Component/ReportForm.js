    ...
    <div className="reportPart">
      ...
      {isAno && isAno === true && isAno !== null && (
        ...
        >
          ...
          <label className={classes.labell}>באיזה עיר החרם התרחש?</label>
          <Select
            defaultValue={city}
            theme={(theme) => ({
              ...theme,
          ...
          <label className={classes.labell}>יודעים באיזה מסגרת?</label>
          <select
            className={classes.formControl}
            required
            value={place}
          ...
          <label className={classes.labell}>באיזה תאריך החרם קרה?</label>
          <input
            className={classes.formControl}
            type="date"
            required
      ...
      {isNotAno && !isAno && isAno !== null && (
        ...
        >
          ...
          <div className={`${classes.nameAndMail}`}>
            <label className={classes.label}>שם</label>
            <input
              type="text"
              value={name}
            ...
            <label className={classes.label}>כתובת אימייל</label>
            <input
              type="email"
              value={email}
          ...
          <label className={classes.label}>יודעים באיזה מסגרת?</label>
          <select
            required
            value={place}
            onChange={(e) => setPlace(e.target.value)}
          ...
          <label className={classes.label}>באיזה תאריך החרם קרה?</label>
          <input
            type="date"
            value={date}
            onChange={(e) => setDate(e.target.value)}
          ...
          <label className={classes.label}>תיאור קצר של המקרה:</label>
          <textarea
            required
            value={message}
            onChange={(e) => setMessage(e.target.value)}
