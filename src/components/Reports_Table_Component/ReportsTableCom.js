...
const ReportsTableCom = () => {
      ...
      try {
        ...
        if (!querySnapshot.empty) {
          ...
          if (documentId !== null) {
            ...
            //write the deleted report to the other data base
            ...
            addDoc(reportCollectionRef1, data);
          }
        }
      } catch (error) {
  ...
  return (
    <>
      ...
      <Link to="/DataGraphs">
        <button className={classes.graphs}>
          <AutoGraphIcon />
          דוח נתונים סטטיסטיים
        </button>
      </Link>
      <button className="history" onClick={historyData}>
